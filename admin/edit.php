...
$payroll=new payroll();
if(!($id=$_GET['id']) || !($info=$payroll->loadEmployee($_GET['id'])))
	...
	<div class="shell">
		...
		<div class="container">
			...
			<div class="slider-holder">
				...
				<p>
				<div class="featured">
					<p ><span style=" font-size:18px; color:#006699">Edit Employee information</span></p><p>Please enter correct information for the new staff. All fields are compulsory  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="index.php"> Go Back</a></p>
							</div>
                ...
                <input type="hidden" name="employeeId" value="<?php echo(isset($param['employeeId'])?strtoupper($param['employeeId']):'') ?>"/> 
                <div class="label-wrap"><?php echo $error; ?></div>
                <table align="center" >
                <tr>
                <td style="width:250px">Employee ID:</td> <td style=""><input type="text"   disabled  style="background:#999999; color:#FFFFFF" "placeholder="e.g ou/ts/005" value="<?php echo(isset($param['employeeId'])?strtoupper($param['employeeId']):'') ?>"  /></td>
                </tr>
                 <tr>
				...
				?>
                   ...
                   <tr>
                <td style="width:200px">Employee Type:</td> <td style="">
                <select name="type"><option value="teaching" <?php echo (isset($param['type'])&&$param['type']=='teaching')?'selected':'' ?>>Teaching Staff</option><option value="non teaching" <?php echo (isset($param['type'])&&$param['type']=='non teaching')?'selected':'' ?>>Non-Teaching Staff</option>
                </select></td>
                </tr><tr>
                ...
                echo '<option value="'.$i.'" '.((isset($param['dateofbirth'])&&$param['dateofbirth']==$i)?'selected':'').'>'.$i.'</option>';
                }
				?>
                </select></td>
                </tr>
                ...
                <?php for ($i=0; $i<=40; $i++ ){ 
                echo '<option value="'.$i.'" '.((isset($param['years_in_service'])&&$param['years_in_service']==$i)?'selected':'').' >'.$i.'</option>';
                }
				?>
                </select></td>
                </tr>
                ...
                <tr>
                <td style="width:200px"></td> <td style=""><input type="submit" class="blue-btn" value="submit" name="save_employee"></td>
                </tr>
