		...
		<div class="container">
			...
			<nav id="navigation">
				...
				<ul>
					...
					<li class="active"><a href="payroll.php">Login</a></li>
	                <li style="margin-left:400px; color: #006600"><p>Hi Stranger! You are not Logged In. </p></li>
				</ul><br/>
				<div class="cl">&nbsp;</div>
                <br/>
			</nav>
			...
			<div class="slider-holder">
				...
				<div class="featured" style="width:750px">
					<p ><p ><span style=" font-size:18px; color:#006699">login Page</span></p>Please supply a valid username and Password. </p>
					</div>
