		...
		<div class="container">
			...
			<div class="slider-holder">
				...
				<div class="featured" style="width:750px">
					<p ><p ><span style=" font-size:18px; color:#006699">Change Password</span></p>You can change your password here</p>
					</div>
  <div class="label-wrap"><?php echo (isset($_SESSION['error']))?'<div style="padding-top:5px; "><center>'.$_SESSION['error'].'</center></div>':''; ?></div>
				</div>
			  </p>
                ...
                <table align="center"  >
               <tr style="border-bottom:border: 2px solid #0a7fb5; margin-bottom:10px; height:40px; background:#0099FF; color:#FFFFFF" ><th colspan="2" style="border-radius:3px; ">Change Password</th>
               </tr>
                ...
                <td style="">
                <input type="password" name="formerpass" ></td>
                </tr>
                  <tr>
                <td style="width:250px">New Password:</td> 
                <td style=""><input type="password" name="newpass1" /></td>
                </tr>
                <tr>
                <td style="width:250px">Retype New Password:</td> 
                <td style=""><input type="password" name="newpass2" /></td>
                </tr>
                <tr>
                ...
                <tr>
                <td style="width:200px"></td> <td style=""><input type="submit" class="blue-btn2" value="Change" name="new_pass"></td>
                </tr>
